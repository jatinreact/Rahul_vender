                            ...
                            <Card className="home_table_card_color p-3">
                                ...
                                <div className='p-3'>
                                    <Grid className='Component_main_grid'>
                                        ...
                                        <Grid item md={5} xs={12}> 
                                         <div className='new_arivalss_home click_arival ' style={{cursor:"pointer"}} >
                                ...
                                <div className='p-3'>
                                    <Grid className='Component_main_grid'>
                                        ...
                                        <Grid item md={5} xs={12}>  <div className='new_arivalss_home click_arival' style={{cursor:"pointer"}}  >
                                            <span className='border_bottom'>Click here for more</span>
                                        </div></Grid>
                                        <Grid item md={2} xs={12}>  </Grid>
                                    </Grid>
